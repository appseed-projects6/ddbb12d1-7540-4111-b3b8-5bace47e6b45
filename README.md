...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-09-01 05:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ddbb12d1-7540-4111-b3b8-5bace47e6b45.git
$ cd ddbb12d1-7540-4111-b3b8-5bace47e6b45
```
